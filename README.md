...
Most translation tools give you dictionary definitions. Tongues gives you what a real person would actually say. It understands idioms, proverbs, slang, and cultural context across 7 languages.
...
- 🌐 **7 Languages** — English, Hindi, Gujarati, Marathi, Tamil, Telugu, Spanish
...
- 👍👎 **Feedback** — Thumbs up/down on every translation
...
- ↔️ **All 42 directions** — Any language to any language
...
Flask Backend (app.py)
     ...
     ├── Calls Claude API with V4 system prompt (14 rules)
...
SQLite Database (tongues.db)
     ...
     ├── feedback      — thumbs up/down with translation context
...
Tongues uses a carefully engineered V4 system prompt with 14 rules covering:
